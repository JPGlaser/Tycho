...
This is a branch of the AMUSE v13.1 script of the same name. The purpose here
is to allow users to explicitly set the RNG state to ensure consistency across
"""
